...
| Server LAN | 10.0.1.0/24  | Серверы    |
...
| VLAN 10 | 10.0.1.1/24 | Server LAN (порты eth1, eth2) |
...
### Подробная последовательность действий по настройке описана в [setup.md](setup.md)

> Сеть была развернута и протестирована в виртуальной среде VMware Workstation на Debian 13
